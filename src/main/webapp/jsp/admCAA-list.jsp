...
<head>
    ...
    <script>
        function updateState(ppid){
            if(confirm("确认下发吗")){
                location.href="${pageContext.request.contextPath}/pcg/updateARState/"+ppid;
            }
        }
    </script>
</head>
...
<form  method="post" action="${pageContext.request.contextPath}/pcg/CadmtoCAA">
...
<table class="tables"  align="center" width="100%" border="1">
    ...
    <c:forEach var="pcgList" items="${pcgList}">
        <tr class="detail_goods">
            ...
            <td>
                <a href="/pcg/admCAAmessage?ppid=${pcgList.ppid}" class="look_detail" >
                    查看详情
                </a>&nbsp;&nbsp;
                <a href="javascript:void(0);" onclick="updateState('${pcgList.ppid}')" class="look_detail" >
                    下发报销金
                </a>
            </td>
        </tr>
...
<div class="bottom_page">
    ...
    <a class="page_change" href="${pageContext.request.contextPath}/pcg/admtoCAA?pageNum=1" title="">首页</a>
    <a class="page_change" href="${pageContext.request.contextPath}/pcg/admtoCAA?pageNum=${page.prePage}" title="">上一页</a>
    <a class="page_change" href="${pageContext.request.contextPath}/pcg/admtoCAA?pageNum=${page.nextPage}" title="">下一页</a>
    <a class="page_change" href="${pageContext.request.contextPath}/pcg/admtoCAA?pageNum=${page.pages}" title="">尾页</a>
</div>
</body>
</html>
