    ...
    <ul class="nav nav-pills nav-stacked dept_sidebar">
        <li role="presentation" class="active">
            ...
            <ul class="nav nav-pills nav-stacked click_render" id="IVT_dept">
                <li role="presentation"><a href="#" class="Ivtm" target="iframe_a">库存</a></li>
    ...
    <ul class="nav nav-pills nav-stacked dept_sidebar">
        <li role="presentation" class="active">
            ...
            <ul class="nav nav-pills nav-stacked click_render" id="Equipment">
                <li role="presentation"><a href="#" class="tofindequipment" target="iframe_a">设备信息</a></li>
...
<script type="text/javascript">
    ...
    $(".topcgplan").click(function () {
        $(this).attr("href", "/pcg/admtopcgplan");
    });
    $(".toCAA").click(function () {
        $(this).attr("href", "/pcg/admtoCAA");
    });

    //库存相关页跳转
    $(".Ivtm").click(function () {
        $(this).attr("href", "/pcg/admtoIvtm");
    });
    ...
    $(".tofindequipment").click(function () {
        $(this).attr("href", "/equipment/admtofindequipment");
    });
    $(".findeRecord").click(function () {
        $(this).attr("href", "/equipment/admfindeRecord");
    });

    //宿舍信息相关页跳转
    $(".toDolist").click(function () {
        $(this).attr("href", "/dormitory/admtoDolist");
    });
